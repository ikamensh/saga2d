...
def example_td_game() -> Game:
    ...
    game.theme = Theme(
        ...
        panel_background_color=(30, 41, 59, 220),
        panel_padding=16,
        button_background_color=(51, 65, 85, 255),
        button_hover_color=(71, 85, 105, 255),
        button_press_color=(30, 41, 59, 255),
        button_text_color=(226, 232, 240, 255),
        button_padding=14,
        button_font_size=26,
