...
def test_background_color_none_passes_no_clear_color(mock_game, mock_backend) -> None:
...
def test_background_color_rgb_passes_clear_color(mock_game, mock_backend) -> None:
...
def test_background_color_rgba_passes_clear_color(mock_game, mock_backend) -> None:
...
def test_background_color_uses_base_scene_when_transparent_overlay(mock_game, mock_backend) -> None:
